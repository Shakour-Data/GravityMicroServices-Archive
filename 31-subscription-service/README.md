...
Subscription Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/subscription-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/subscription-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/subscription-service.git
...
The service will be available at http://localhost:8031
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/subscription_service_db
...
- **OpenAPI JSON**: http://localhost:8031/openapi.json
