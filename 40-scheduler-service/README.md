...
Job Scheduling Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/scheduler-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/scheduler-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/scheduler-service.git
...
The service will be available at http://localhost:8040
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/scheduler_service_db
