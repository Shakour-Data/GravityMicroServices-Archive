...
Feedback Collection Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/feedback-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/feedback-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/feedback-service.git
cd feedback-service
```
...
The service will be available at http://localhost:8037
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/feedback_service_db
...
- **OpenAPI JSON**: http://localhost:8037/openapi.json
