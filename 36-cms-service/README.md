...
Content Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/cms-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/cms-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/cms-service.git
cd cms-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/cms_service_db
...
- **Swagger UI**: http://localhost:8036/docs
- **ReDoc**: http://localhost:8036/redoc
- **OpenAPI JSON**: http://localhost:8036/openapi.json
