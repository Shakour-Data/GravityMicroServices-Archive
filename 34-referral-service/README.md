...
Referral Program Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/referral-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/referral-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/referral-service.git
cd referral-service
```
...
The service will be available at http://localhost:8034
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/referral_service_db
...
- **OpenAPI JSON**: http://localhost:8034/openapi.json
