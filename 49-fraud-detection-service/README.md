...
Fraud Detection Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/fraud-detection-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/fraud-detection-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/fraud-detection-service.git
...
The service will be available at http://localhost:8049
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/fraud_detection_service_db
