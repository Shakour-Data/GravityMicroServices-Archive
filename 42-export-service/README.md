...
Data Export Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/export-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/export-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/export-service.git
cd export-service
```
...
The service will be available at http://localhost:8042
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/export_service_db
...
- **OpenAPI JSON**: http://localhost:8042/openapi.json
