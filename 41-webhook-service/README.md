...
Webhook Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/webhook-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/webhook-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/webhook-service.git
cd webhook-service
```
...
The service will be available at http://localhost:8041
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/webhook_service_db
