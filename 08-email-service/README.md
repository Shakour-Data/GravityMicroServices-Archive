...
Email Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/email-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/email-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/email-service.git
cd email-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/email_service_db
