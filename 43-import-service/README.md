...
Data Import Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/import-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/import-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/import-service.git
cd import-service
```
...
The service will be available at http://localhost:8043
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/import_service_db
...
- **OpenAPI JSON**: http://localhost:8043/openapi.json
