...
Analytics Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/analytics-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/analytics-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/analytics-service.git
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/analytics_service_db
