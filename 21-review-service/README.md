...
Review & Rating Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/review-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/review-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/review-service.git
cd review-service
```
...
The service will be available at http://localhost:8021
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/review_service_db
