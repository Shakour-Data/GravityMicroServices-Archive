...
Distributed Cache Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/cache-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/cache-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/cache-service.git
cd cache-service
```
...
The service will be available at http://localhost:8014
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/cache_service_db
...
- **OpenAPI JSON**: http://localhost:8014/openapi.json
