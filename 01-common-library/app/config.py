...
File         : config.py
Description  : Configuration settings for Common Library
Language     : English (UK)
...
class Settings(BaseSettings):
    ...
    # ==============================================================================
    APP_NAME: str = Field(default="01-common-library", description="Service name")
    ...
    DATABASE_URL: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5401/common_library",
        description="PostgreSQL connection URL"
    )
    DB_HOST: str = Field(default="localhost", description="Database host")
    DB_PORT: int = Field(default=5401, description="Database port")
    DB_NAME: str = Field(default="common_library", description="Database name")
    ...
    # ==============================================================================
    REDIS_URL: str = Field(
        default="redis://localhost:6301/0",
        description="Redis connection URL"
    )
    REDIS_HOST: str = Field(default="localhost", description="Redis host")
    REDIS_PORT: int = Field(default=6301, description="Redis port")
    ...
    TEST_DATABASE_URL: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/test_common_library",
    ...
    # ==============================================================================
    API_TITLE: str = Field(
        default="Common Library API",
        description="API title"
    )
    API_DESCRIPTION: str = Field(
        default="Independent Common Library Microservice",
