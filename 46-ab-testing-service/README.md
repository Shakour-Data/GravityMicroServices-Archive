...
A/B Testing Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/ab-testing-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/ab-testing-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/ab-testing-service.git
...
The service will be available at http://localhost:8046
...
SERVICE_NAME=ab-testing-service
SERVICE_PORT=8046
ENVIRONMENT=development

# Database Configuration
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/ab_testing_service_db
...
- **Swagger UI**: http://localhost:8046/docs
- **ReDoc**: http://localhost:8046/redoc
- **OpenAPI JSON**: http://localhost:8046/openapi.json
