...
Audit Logging Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/audit-log-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/audit-log-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/audit-log-service.git
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/audit_log_service_db
