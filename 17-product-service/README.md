...
Product Catalog Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/product-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/product-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/product-service.git
cd product-service
```
...
The service will be available at http://localhost:8017
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/product_service_db
