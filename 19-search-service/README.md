...
Search Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/search-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/search-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/search-service.git
cd search-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/search_service_db
