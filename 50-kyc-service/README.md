...
KYC (Know Your Customer) Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/kyc-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/kyc-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/kyc-service.git
cd kyc-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/kyc_service_db
