...
Recommendation Engine Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/recommendation-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/recommendation-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/recommendation-service.git
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/recommendation_service_db
