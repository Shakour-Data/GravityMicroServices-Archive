...
Centralized Logging Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/logging-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/logging-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/logging-service.git
cd logging-service
```
...
The service will be available at http://localhost:8039
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/logging_service_db
...
- **Swagger UI**: http://localhost:8039/docs
- **ReDoc**: http://localhost:8039/redoc
- **OpenAPI JSON**: http://localhost:8039/openapi.json
