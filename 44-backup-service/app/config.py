...
File         : config.py
Description  : Configuration settings for Backup Service
Language     : English (UK)
...
License: MIT License
Repository: https://github.com/Shakour-Data/44-backup-service
...
class Settings(BaseSettings):
    ...
    # ==============================================================================
    APP_NAME: str = Field(default="44-backup-service", description="Service name")
    APP_VERSION: str = Field(default="1.0.0", description="Service version")
    DEBUG: bool = Field(default=False, description="Debug mode")
    LOG_LEVEL: str = Field(default="INFO", description="Logging level")
    ENVIRONMENT: str = Field(default="development", description="Environment name")
    PORT: int = Field(default=8044, description="Application port")
    
    # ==============================================================================
    # Database Configuration (PostgreSQL)
    # ==============================================================================
    DATABASE_URL: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5444/backup_service",
        description="PostgreSQL connection URL"
    )
    DB_HOST: str = Field(default="localhost", description="Database host")
    DB_PORT: int = Field(default=5444, description="Database port")
    DB_NAME: str = Field(default="backup_service", description="Database name")
    ...
    # ==============================================================================
    REDIS_URL: str = Field(
        default="redis://localhost:6344/0",
        description="Redis connection URL"
    )
    REDIS_HOST: str = Field(default="localhost", description="Redis host")
    REDIS_PORT: int = Field(default=6344, description="Redis port")
    ...
    TEST_DATABASE_URL: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/test_backup_service",
    ...
    # ==============================================================================
    API_TITLE: str = Field(
        default="Backup Service API",
        description="API title"
    )
    API_DESCRIPTION: str = Field(
        default="Independent Backup Service Microservice",
