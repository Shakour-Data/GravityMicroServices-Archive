...
Backup Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/backup-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/backup-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/backup-service.git
cd backup-service
```
...
The service will be available at http://localhost:8044
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/backup_service_db
...
- **ReDoc**: http://localhost:8044/redoc
- **OpenAPI JSON**: http://localhost:8044/openapi.json
