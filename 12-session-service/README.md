...
Session Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/session-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/session-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/session-service.git
cd session-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/session_service_db
