...
Shipping Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/shipping-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/shipping-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/shipping-service.git
cd shipping-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/shipping_service_db
...
- **Swagger UI**: http://localhost:8026/docs
- **ReDoc**: http://localhost:8026/redoc
- **OpenAPI JSON**: http://localhost:8026/openapi.json
