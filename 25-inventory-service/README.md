...
Inventory Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/inventory-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/inventory-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/inventory-service.git
...
The service will be available at http://localhost:8025
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/inventory_service_db
