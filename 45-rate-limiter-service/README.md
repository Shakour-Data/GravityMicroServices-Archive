...
Rate Limiting Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/rate-limiter-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/rate-limiter-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/rate-limiter-service.git
...
The service will be available at http://localhost:8045
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/rate_limiter_service_db
...
- **Swagger UI**: http://localhost:8045/docs
- **ReDoc**: http://localhost:8045/redoc
- **OpenAPI JSON**: http://localhost:8045/openapi.json
