...
Gamification Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/gamification-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/gamification-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/gamification-service.git
...
The service will be available at http://localhost:8051
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/gamification_service_db
...
- **OpenAPI JSON**: http://localhost:8051/openapi.json
