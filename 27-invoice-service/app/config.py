...
File         : config.py
Description  : Configuration settings for Invoice Service
Language     : English (UK)
...
License: MIT License
Repository: https://github.com/Shakour-Data/27-invoice-service
...
class Settings(BaseSettings):
    ...
    # ==============================================================================
    APP_NAME: str = Field(default="27-invoice-service", description="Service name")
    APP_VERSION: str = Field(default="1.0.0", description="Service version")
    DEBUG: bool = Field(default=False, description="Debug mode")
    LOG_LEVEL: str = Field(default="INFO", description="Logging level")
    ENVIRONMENT: str = Field(default="development", description="Environment name")
    PORT: int = Field(default=8027, description="Application port")
    
    # ==============================================================================
    # Database Configuration (PostgreSQL)
    # ==============================================================================
    DATABASE_URL: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5427/invoice_service",
        description="PostgreSQL connection URL"
    )
    DB_HOST: str = Field(default="localhost", description="Database host")
    DB_PORT: int = Field(default=5427, description="Database port")
    DB_NAME: str = Field(default="invoice_service", description="Database name")
    ...
    # ==============================================================================
    REDIS_URL: str = Field(
        default="redis://localhost:6327/0",
        description="Redis connection URL"
    )
    REDIS_HOST: str = Field(default="localhost", description="Redis host")
    REDIS_PORT: int = Field(default=6327, description="Redis port")
    ...
    TEST_DATABASE_URL: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/test_invoice_service",
    ...
    # ==============================================================================
    API_TITLE: str = Field(
        default="Invoice Service API",
        description="API title"
    )
    API_DESCRIPTION: str = Field(
        default="Independent Invoice Service Microservice",
