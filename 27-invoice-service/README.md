...
Invoice Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/invoice-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/invoice-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/invoice-service.git
cd invoice-service
```
...
The service will be available at http://localhost:8027
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/invoice_service_db
...
- **OpenAPI JSON**: http://localhost:8027/openapi.json
