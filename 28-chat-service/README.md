...
Real-time Chat Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/chat-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/chat-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/chat-service.git
cd chat-service
```
...
The service will be available at http://localhost:8028
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/chat_service_db
...
- **OpenAPI JSON**: http://localhost:8028/openapi.json
