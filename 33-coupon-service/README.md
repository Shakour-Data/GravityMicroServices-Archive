...
Coupon Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/coupon-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/coupon-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/coupon-service.git
cd coupon-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/coupon_service_db
...
- **OpenAPI JSON**: http://localhost:8033/openapi.json
