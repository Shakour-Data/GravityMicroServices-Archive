...
Tax Calculation Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/tax-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/tax-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/tax-service.git
cd tax-service
```
...
The service will be available at http://localhost:8048
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/tax_service_db
...
- **OpenAPI JSON**: http://localhost:8048/openapi.json
