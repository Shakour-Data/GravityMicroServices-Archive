...
Monitoring Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/monitoring-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/monitoring-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/monitoring-service.git
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/monitoring_service_db
...
- **Swagger UI**: http://localhost:8038/docs
- **ReDoc**: http://localhost:8038/redoc
- **OpenAPI JSON**: http://localhost:8038/openapi.json
