...
File         : __init__.py
Description  : Core module package initialization.
Language     : English (UK)
...
from app.core.consul_client import consul_client, ConsulClient, HealthCheck, ServiceInstance

__all__ = ["consul_client", "ConsulClient", "HealthCheck", "ServiceInstance"]
