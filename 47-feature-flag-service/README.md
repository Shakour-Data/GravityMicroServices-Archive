...
Feature Flag Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/feature-flag-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/feature-flag-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/feature-flag-service.git
...
The service will be available at http://localhost:8047
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/feature_flag_service_db
