...
SMS Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/sms-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/sms-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/sms-service.git
cd sms-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/sms_service_db
