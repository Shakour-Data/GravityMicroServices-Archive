...
Reporting Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/reporting-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/reporting-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/reporting-service.git
...
The service will be available at http://localhost:8024
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/reporting_service_db
