...
Configuration Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/config-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/config-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/config-service.git
cd config-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/config_service_db
