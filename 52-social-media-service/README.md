...
Social Media Integration Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/social-media-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/social-media-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/social-media-service.git
...
The service will be available at http://localhost:8052
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/social_media_service_db
...
- **OpenAPI JSON**: http://localhost:8052/openapi.json
