...
Loyalty Program Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/loyalty-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/loyalty-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/loyalty-service.git
cd loyalty-service
```
...
The service will be available at http://localhost:8032
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/loyalty_service_db
...
- **OpenAPI JSON**: http://localhost:8032/openapi.json
