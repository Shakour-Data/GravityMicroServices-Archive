...
Order Management Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/order-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/order-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/order-service.git
cd order-service
```
...
The service will be available at http://localhost:8016
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/order_service_db
