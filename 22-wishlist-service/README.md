...
Wishlist Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/wishlist-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/wishlist-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/wishlist-service.git
cd wishlist-service
```
...
The service will be available at http://localhost:8022
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/wishlist_service_db
