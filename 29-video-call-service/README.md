...
Video Call Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/video-call-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/video-call-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/video-call-service.git
...
The service will be available at http://localhost:8029
...
SERVICE_NAME=video-call-service
SERVICE_PORT=8029
ENVIRONMENT=development

# Database Configuration
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/video_call_service_db
...
- **Swagger UI**: http://localhost:8029/docs
- **ReDoc**: http://localhost:8029/redoc
- **OpenAPI JSON**: http://localhost:8029/openapi.json
