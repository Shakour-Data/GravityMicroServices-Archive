...
Shopping Cart Service for the Gravity MicroServices Platform.

[![CI/CD](https://github.com/Shakour-Data/cart-service/actions/workflows/ci.yml/badge.svg)](https://github.com/Shakour-Data/cart-service/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/Shakour-Data/cart-service.git
cd cart-service
```
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/cart_service_db
